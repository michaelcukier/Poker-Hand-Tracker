from hands.new_hands import get_hands_info
from opponents.new_opponents import extract_opponents_names
from tournament.create_new_tournament import extract_new_tournament
